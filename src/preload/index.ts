...
const api: FoveaApi = {
  ...
  history: { list: (query = '') => invokeResult(IPC.historyList, query), open: (id) => invokeResult(IPC.historyOpen, id), delete: (id) => invokeResult(IPC.historyDelete, id), clear: () => invokeResult(IPC.historyClear) },
