...
const api: FoveaApi = {
  ...
  question: {
    get: (id) => invokeResult(IPC.questionGet, id), getFullImage: (id) => invokeResult(IPC.questionGetFullImage, id), setSelection: (id, selection) => invokeResult(IPC.questionSetSelection, id, selection), setPinned: (id, pinned) => invokeResult(IPC.questionSetPinned, id, pinned), setPreviewOpen: (id, open) => invokeResult(IPC.questionSetPreviewOpen, id, open), send: (id, text) => invokeResult(IPC.questionSend, id, text), retry: (id, exchangeId) => invokeResult(IPC.questionRetry, id, exchangeId), resolveWebSearch: (id, requestId, approved) => invokeResult(IPC.questionResolveWebSearch, id, requestId, approved), stop: (id) => invokeResult(IPC.questionStop, id), close: (id) => invokeResult(IPC.questionClose, id), newSnip: (id) => invokeResult(IPC.questionNewSnip, id),
