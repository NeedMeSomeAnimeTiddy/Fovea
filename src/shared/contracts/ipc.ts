...
export interface FoveaApi {
  ...
  capture: { start(mode: CaptureMode): Promise<void>; getContext(): Promise<CaptureContext>; select(rectangle: Rectangle, operations?: ImageEditOperation[], preferWebSearch?: boolean): Promise<void>; cancel(): Promise<void> }
